    ...
    return(
      <div className="">
        ...
        <div className="row flex-row">
            ...
            <div className="col-xl-12">
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>The Empire was born, in the wake of the most destructive war its world had ever seen. Officially established on the 10th of December, 1038 ALB<span className="fnnum">.</span><span className="fncon">After Lunar Banishment</span>, the Empire was created via a treaty between the major world powers - The Royal Confederacy of MineLegotia, The Principality of Equestria, the United States of Manehatten, The Serene Federation of Lunar Equestria, The People's Republics and Collectives of North West Equestria, The Crystal Empire, The Federation of Changeling Republics, The Republic of Equestria, The Southern Confederacy of Equestrian States, The Republic of Threslesia, The Griffon Confederacy of States, The United Republics of Legotia; The United Republics of New Mareland, The United States of Hippogriffa, & The Kirin Unitary Republic. These states banded together to say 'never again' to the horrors of the Shattered War. The war where Pax Celestica finally ended in the flames of <strong>Burning Wednesday</strong>, a national crisis from which the once serene Principality shattered into pieces as weapons fell into the hooves and claws of radicals, ideologues, reformists, and all in between.
                </p>
            </div>
            <div className="col-xl-12">
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Torn between old hatred between the equine races, the decadance of the aristocracy, the infiltration of agitators from aboard, and new age idealists - the project of the Solar Princess fell into ruin as the blood of the ponies filled their continent. At first as the states broke off, tensions flared and boiled over before evaporating... the short <strong>Ten Months Collapse</strong> ended just as soon as it started. But the peace of these new states was fragile. All it took was just one bad day, one bad crash, one angry pony, and one unfortunate soul at the end of a barrel... 
                </p>
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>...and it all went to hell. 
                </p>
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>
                    The Changelings got dragged into intervening in Applelousa and its southern provinces as reports of their people being subjugated by a desperate and failing Republic of Equestria burned in the flames of the advancing Restorationists. The Griffons went northwards to assist their Republican allies against the bugs. The Thestrals banded together in Central Equestria, surrounded by Revanchist Unicorn Armies, Rightist Communes, and a desperate Lunar Princess. Manehatten seceeded and declared for the end of the Principality permanently. Vanhoofer was seized by the followers of Larks and Bagel as their city was shelled by Crystallian Crusiers. And the Empire to the East, came in desperate, to try and stop the war that was wrecking their economy and secure themselves a proper supply of coal and crystals.
                </p>
            </div>
            <div className="col-xl-12">
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>The world burned. Sisters armed against their fathers, brothers burying mothers, the deployment of Phosgene Gas against civilian and military targets, the razing of cities, death, destruction, and finally, nuclear strikes against Canterlot. 
                </p>
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>From 1023 to 1038 ALB, for fifteen years, the world of Eunia had itself a war which they never seen before. The first war of industrialized destruction. And it was to end with a single Empire, barely managing to survive itself, dragging the remnants of the old world together so they may build for themselves a future absent of horrid war. Under the guidance of one of the few remaining <strong><Link href="kaisarverse/concept/lipas" className="link-color-unique"><span>Lipas</span></Link></strong>, the Kaisar of the Royal Confederacy of MineLegotia and Equestria, they hoped they shall no longer see war. And see but prosperity, but progress, but advancement, but equality, but inclusion, but justice, but most importantly above it all, peace!
                </p>
                <br />
                <p className="card-text mb-auto" style={{"textAlign":"justify"}}>And things got worse.
                </p>
            </div>
        </div>
        </div>
        <div className="col px-4 d-flex flex-column position-static bg-whites ">
                  <div className="row flex-row">
                    <div className="col-xl-12">
                      <br />
        ...
        <div className="col px-4 pb-4 d-flex flex-column position-static bg-whites ">
                  <div className="row flex-row">
                    <div className="col-xl-12">
                      ...
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>When considering the universe, one must remember that in the logic of the Empire, that the universe of the Empire exists on, something that can be imagined as a 3D plane. These three axes determine the nature of the reality. There is the Alpha, Beta, and Delta axes. Of interest is the Beta Axis, in which could be best described as the 'seed' of a universe sort of like seeds in video games. Now, if one has a beta variable/seed of '48839SHDE', the variable next door of '48839SHF' would be almost similar, except for some minor modification. The larger the deviation, the more different the universe is. Interuniversal travel is often not possible due to the fact that there is an infinitely large distance between universes created by previous universes ceasing to exist due to fluctuations from higher Alpha layers. However, these infinite distances can be crossed as discovered by the Empire by using an anchor before creating the method of transportation. This can be done by, essentially taking something that represents as much of the material present within a given universe, like a book or data encrypted on a drive, and forcing it to jump into another universe using ludrcious amounts of energy. And once expelled from the origin universe, the book will maintain a vector that'll change to land into a nearby universe that holds close enough to its identity. Once landed, the origin universe can establish an easier link with the new universe through that anchor and create a more permanent link. 
                      </p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Thus, as the Empire began rebuilding, it inherited a project from the remnants of the Equestrian governments regarding interuniversal travel based on the writings of an old unicorn wizard. Deciding that this was a worthwhile project, the Empire chose to start pursuing it in earnest. Perhaps, a new world could be found. With its new wonders and so, that the Empire could in a way, repent for the horrors they've committed. 
                      </p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Instead, they found an Equestria on the brink of war and collapsing into war as their own world as. Parasitic and inefficient aristocrats choking out the principality, as claimed by a stallion that was exiled and whom they first discovered. <strong> <Link href="/worlds/kaisarverse/char/preventus-i-eye" className="link-color-unique"><span>Preventus I Eye</span></Link></strong>. Adopted quickly into the Imperial Family, the Kaisar directed the Empire for an encroaching upon this world to bring about their ideals of Harmony they've managed to forged out of war. Drawing in the states of <strong> <Link href="/worlds/kaisarverse/nation/snowlandia" className="link-color-unique"><span>Snowlandia</span></Link></strong> and <strong> <Link href="/worlds/kaisarverse/nation/calavaria" className="link-color-unique"><span>Calavaria</span></Link></strong> into their sphere, the Empire moved to topple the corrupt regime and sought to bring about Democracy to the region. A coup, a civil war, and arms being shipped into <strong><Link href="/planet/equus-2" className="link-color-unique"><span>Equestria-2</span></Link></strong> allowed for the Empire to claim for themselves a new democratic protectorcate in the new world under the reign of the aforementioned Preventus. But unbeknownst to the Empire and Her new found allies, the old rulers of Canterlot, <strong><Link href="/char/the-deciever" className="link-color-unique"><span>the Deciever</span></Link></strong>, ran off along with the rest of her deviled possy into other worlds to convince other Equestrias to launch a crusade back against the Empire.
                      </p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>An alliance of states were gathered up by the Deciever, and declaring the birth of the <strong> <Link href="/worlds/kaisarverse/nation/restorationist-equestrian-coalition" className="link-color-unique"><span>Restorationist Equestrian Coalition</span></Link></strong>, they opened up portals once more on the eastside of the newly founded state of <strong> <Link href="/worlds/kaisarverse/nation/mleocun" className="link-color-unique"><span>Mleocun</span></Link></strong> to take back their deceitful rule. The Empire battled with the Coalition. The Empire, a child of war, fostering along itself several younger nations with it as they picked up the sword once more to advance against their enemies, horrid autocrats and corrupt rulers. The Coalition, steadied itself as they prepared themselves for a righteous reclaimation and liberation of their old world. Both sides, did not knew of just how bad the war was going to become as by the second year, a stalemate occured on the center mountain ridges of Mleocun and the fighting grew bitter and regressed.</p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>The old nature of trench warfare slowly creeped back in. A novelty to the numerically superior Coalition and an ancient horror for the technologically ascendent Empire. Both sides saw themselves spiral into a feast of barbarism in the battles of the Mideast of Mleocun. With trench lines scattered up and down the Mareisisipi river, and often mountains serving as just but another type of land to dig trenches in. Each side saw themselves trading lives for inches of trenches that may with ease be retaken by the enemy for an equivalent magnitude of lives. A horror which saw notable rivers clogged up with bodies. </p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>And when stagnation set in by the third year of fighting, desperation creeped its ugly head over the horizon to both sides as it increasingly became clear that the war will not end easily. Trench raids grew increasingly common, as so was the deployment of mustard gas as the Empire rolled out old tactics to break Coalition Lines. The Coalition responded by increasingly growing dependent on magically enhanced soldiers for desperate breakthroughs, and using spells to cast foul curses on Imperial troops. The Empire responded in kind with continued development of bioweapons and incidenary weapons. Incinerating all those that survived plagues and horrific monstrosities. But like all ladders, there was another rung to climb. And another. First came spells, then <strong><Link href="kaisarverse/concept/memetics" className="link-color-unique"><span>Memetics</span></Link></strong>, then plaguebombs, then antimemetic viruses, then virulent pathogens. The trench battles slowly lost any sense of limitation to trenches. With powerful weapons, hundreds of kilometres of trenches could be lost in a day due to a particularly effective self replicating memetic attack driving all soldiers within it insane, or a particularly dastardly bioweapon simply murdering them all. Cities were levelled as gunfire traded fire with screeching noises of hell, virulent disease, and constant bombing. But yet, this was all still relatively limited to Mleocun. The main field of battle.</p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>The war kept going on, first a decade, then another, then a third more, then a century. By this point, the MineLegoEquestrians and arcane defectors from the Coalition had begun developing early motic-based genetic engineering, to try and stave off extinction from a weapon that both sides knew they both had. Nuclear weapons.</p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Unlike all the weapons of war they've deployed, nuclear weapons could verily easily be deployed and attempt to be delivered cross universes. Memetics required sapient vectors, which by now had been particularly exhausted by either genetic upgrades, arcane shielding, or simple raw survival making them unviable. Biological warfare became harder to use as troops grew more knowledgable in how to stop such spreads, using their masks and combat suits as second skins. Everything was slowly being countered, but nuclear weapons. </p>
                      <br/>
                      <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Both sides can't really stop nuclear weapons, more of the effect that both sides had no possible idea how one would utilize them effectively and prevent a second strike from the enemy. But the thought of escalating the ladder became more and more of a thought for the Coalition as the Empire slowly took ground. Mechanised warfare had rolled back in after multiple failed attempts, and the lines were drawn near the East Coast. With the centre of operations Manehatten on the line for collapse. The call was made.</p>
                    </div>
                  </div>
        ...
        <div className="col px-4 pb-4 d-flex flex-column position-static bg-whites ">
          <div className="row flex-row">
                  ...
                  <p className="card-text mb-auto" style={{"textAlign":"justify"}}>Approxmiately 330 million Imperials, including allies, and approximately 3.6 billion Coalition citizens perished in the Thermonuclear exchange. The Empire, shouldering the thermonuclear exchange better thanks to being able to shoot down a portion of the missiles launching the payloads. The same was similar for the Coalition, but they underestimated the total number of missiles that would be fired from the Empire's side. Obliterating more cities than they ever could across their coalition. 
                  </p>
                  <br/>
                  <p className="card-text mb-auto" style={{"textAlign":"justify"}}>With most of their enemy in ruin, the Empire moved on, unopposed with what remained of their allies as well to properly end the war. Repeating the procedures they made that brough them into Equestria-2 in the first place, they moved on to deal with remains of the Coalition. Anger striking out of their sword against an enemy who dared invade them. The Empire managed to ease with steamroll the remains of the Coalition, folding colonies and protectorcates out of the remnants... 
                  </p>
                  <br/>
                  <p className="card-text mb-auto" style={{"textAlign":"justify"}}>It would be an understatement to say that the Great Multiversal War was both great and a near present idea within the Empire's mythos. One does not remove such a scarring and jarring incident away from a nation's collective consciousness easily, and for the remainder of the Empire's populations and its allies the scars of the war ran deep enough to become the foundational myth for their states after the war. And the war, would define the way the nations of the Multiversal Empire interacted in the future and how they saw themselves... </p>
                  </div>
...
export default KaisarverseMainContent;