      ...
      <div className="col px-4 pb-4 d-flex flex-column position-static bg-whites ">
        <div className="row flex-row">
          ...
          <div className="col-xl-12">
            <Image src="https://i.ibb.co.com/gMvWWFq/1-0-No-Cities-Artboard-1-2-5x.png"   alt="A Very Big Map. Open in New Tab is recommended" width={3000} height={1688} layout="responsive" placeholder="blur"  sizes="(max-width: 768px) 100vw, 33vw" priority /><br />
          ...
          <div className="col-xl-12">
            <br />
            <p className="card-text mb-auto" style={{ "textAlign": "justify" }}>The Empire was born, in the wake of the most destructive war its world had ever seen. Officially established on the 10th of December, 1038 ALB<span className="fnnum">.</span><span className="fncon">After Lunar Banishment</span>, the Empire was created via a treaty between the major world powers - The Federal Commonwealth of the Empire of Minean and Perdeland, Hiplegref Queendom, Kristal Diguo, Associated States of Griffrefkind, Zongmao Federated Republic, Qirine Diguo, Bianxingling Federal State, and Constituent States of the Continents of Sejuklaut, Minea, Legti, Madi, and Pohoska. These states banded together to say 'never again' to the horrors of the Shattered War. The war where Pax Maguo finally ended in the flames of <strong>Burning Wednesday</strong>, a national crisis from which the once serene Principality shattered into pieces as weapons fell into the hooves and claws of radicals, ideologues, reformists, and all in between.
            </p>
          </div>
          <div className="col-xl-12">
            <br />
