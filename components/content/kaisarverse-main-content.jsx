      ...
      <div className="">
        ...
        <div className="row flex-row">
            ...
            <div className="col-xl-8">
                <p className="card-text mb-auto" style={{"text-align":"justify;"}}>At the centre of this lore mess, is the Empire of MineLegotia and Equestria. Or it's full name, the Federal Bureaucratic Commonwealth of the States of the Empire of MineLegotia and Equestria and Crystallia and Hippogriffia and Griffonia and of the Manehattenite Republic and of Kirinia and the Many States of Equestria and New Mareland and the Changeling Associated States and Her Most Majestic Commonwealth and Colonies and Protectorates Under Her Most Serene Protection. The Empire is a state of many states, and such a long name, is not that surprising if one knew that.
                </p>
            </div>
